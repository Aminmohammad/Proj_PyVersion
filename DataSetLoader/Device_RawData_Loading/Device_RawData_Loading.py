...
def device_raw_data_loading(device_data_set_address,
        ...
        for burst_Index in range(len(key_values)):
            ...
            for subRegion_Index in range(number_of_subregions + 1):
                ...
                if subRegion_Index <= number_of_subregions:
                    ...
                    vertical_hash_map_of_a_single_burst[
                        "pure_single_subRegion" + str(subRegion_Index)] = a_single_subregion

                    vertical_hash_map_of_a_single_burst[
                        "amp_single_subRegion" + str(subRegion_Index)] = amplitude

                    vertical_hash_map_of_a_single_burst[
                        "phase_single_subRegion" + str(subRegion_Index)] = phase

                    vertical_hash_map_of_a_single_burst[
                        "ifreq_single_subRegion" + str(subRegion_Index)] = ifrequency

                    # saving the Single Burst
                    vertical_hashmap_of_all_bursts[
                        "a_Single_Burst" + str(burst_Index)] = vertical_hash_map_of_a_single_burst
                    ...
                    vertical_hash_map_of_a_single_burst[
                        "pure_single_subRegion" + str(subRegion_Index)] = pure_all_subregions

                    vertical_hash_map_of_a_single_burst[
                        "amp_single_subRegion" + str(subRegion_Index)] = amplitude_all_subregions

                    vertical_hash_map_of_a_single_burst[
                        "phase_single_subRegion" + str(subRegion_Index)] = phase_all_subregions

                    vertical_hash_map_of_a_single_burst[
                        "ifreq_single_subRegion" + str(subRegion_Index)] = ifrequency_all_subregions

                    # saving the Single Burst
                    vertical_hashmap_of_all_bursts[burst_Index] = vertical_hash_map_of_a_single_burst
